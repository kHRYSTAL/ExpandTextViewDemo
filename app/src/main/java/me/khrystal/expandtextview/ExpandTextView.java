...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    protected void initWithAttrs(Context context, AttributeSet attrs) {
        ...
        int textColor = a.getColor(R.styleable.ExpandTextStyle_textColor,
                defaultTextColor);
        textSize = a.getDimensionPixelSize(R.styleable.ExpandTextStyle_textSize, defaultTextSize);
        maxLine = a.getInt(R.styleable.ExpandTextStyle_maxLine, defaultLine);
        text = a.getString(R.styleable.ExpandTextStyle_text);
